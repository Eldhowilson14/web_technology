...
const registerUser = asyncHandler(async (req, res) => {
  ...
  const existedUser = await User.findOne({
    $or: [{ email: email }, { schoolIdNo: schoolIdNo }],
  });
  if (existedUser) {
    throw new ApiError(
      409,
...
>
  <div style="margin: 50px auto; width: 70%; padding: 20px 0">
    ...
    <p>
      Thank you for choosing InfoSystem. Please click the button below to
      verify your email.
    </p>
    ...
    <p style="font-size: 0.9em">Regards,<br />InfoSystem</p>
...
<html lang="en">
  ...
  const email = "InfoSystem@gmail.com";
